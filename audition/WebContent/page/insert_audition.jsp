...
<form method="POST" action="action/insert_audition_data.jsp">
	<table border=1>
		<tr>
			<td>참가번호</td>
			<td><input name="artist_id" autocomplete="off">*참가번호는 (A000)4자리입니다</td>
		</tr>
		<tr>
			<td>참가자명</td>
			<td><input name="artist_name" autocomplete="off"></td>
		</tr>
		<tr>
			<td>생년월일</td>
			<td>
				<input type="number" name="year">년
				<input type="number" name="month">월
				<input type="number" name="day">일
			</td>
		</tr>
		<tr>
			<td>성별</td>
